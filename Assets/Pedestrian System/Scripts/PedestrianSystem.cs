...
public class PedestrianSystem : MonoBehaviour 
{
	...
	public  Camera                           m_mainGameCamera       = null;                                   // assign this so all pedestrians know when to cull themselves out of view.
	public  float                            m_distanceToCull       = 200.0f;                                 // this is the distance from the camera to cull pedestrians.
	...
	public bool IsInView(Vector3 a_worldPos)
	{
		if(!m_mainGameCamera)
			return true;
		...
		if(dir.magnitude > m_distanceToCull)
			return false;
